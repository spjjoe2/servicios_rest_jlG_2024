...
public class VuelosController {
	...
	public Reserva datosVuelolPorId(@PathVariable("idVuelo") int idVuelo){	 
		return vuelosService.findById(idVuelo);
	}
	
	@GetMapping(value="vuelos/{destino}/{plazas}",produces=MediaType.APPLICATION_JSON_VALUE)
	public List<Reserva> listaVuelos(@PathVariable("destino") String destino,@PathVariable("plazas") int plazas){
